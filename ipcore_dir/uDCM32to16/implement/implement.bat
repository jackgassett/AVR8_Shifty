...
xst -ifn xst.scr
move uDCM32to16_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\uDCM32to16.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc uDCM32to16.ucf uDCM32to16_exdes

echo 'Running map'
map -timing -pr b uDCM32to16_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm uDCM32to16_exdes -w routed.ncd routed.vhd
cd ..
